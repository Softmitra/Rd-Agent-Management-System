...
class RDAccountController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.rd-accounts.index', compact('rdAccounts', 'summary'));
    }
    ...
    public function create()
    {
        ...
        $agents = \App\Models\Agent::where('is_active', true)
            ...
            ->get();
        return view('admin.rd-accounts.create', compact('customers', 'agents'));
    }
    ...
    public function show(RDAccount $rdAccount)
    {
        ...
        return view('admin.rd-accounts.show', compact('rdAccount'));
    }
    ...
    {
        $customers = Customer::all();
        return view('admin.rd-accounts.edit', compact('rdAccount', 'customers'));
    }
    ...
    public function close(RDAccount $rdAccount)
    {
        ...
        return redirect()
            ->route('admin.rd-accounts.show', $rdAccount)
     ...
     */
    public function getAgentByCustomer($customerId)
    {
    ...
    public function getCustomersByAgent($agentId)
    {
        ...
        $customers = \App\Models\Customer::where('agent_id', $agentId)
            ->select('id', 'name')
            ->get();
