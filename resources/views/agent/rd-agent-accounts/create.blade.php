                        ...
                        <form action="{{ route('agent.rd-agent-accounts.store') }}" method="POST" id="rdAccountForm">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2-customer @error('customer_id') is-invalid @enderror"
                                    ...
                                    @forelse($customers as $customer)
                                        <option value="{{ $customer->id }}" data-phone="{{ $customer->mobile_number }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('account_number') is-invalid @enderror"
                                    maxlength="12" id="account_number" name="account_number"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('registered_phone') is-invalid @enderror"
                                    id="registered_phone" name="registered_phone" value="{{ old('registered_phone') }}"
                            ...
                            <div class="form-group joint-holder-section" style="display: none;">
                                ...
                                <input type="text" class="form-control @error('joint_holder_name') is-invalid @enderror"
                                    id="joint_holder_name" name="joint_holder_name" value="{{ old('joint_holder_name') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text"
                                        class="form-control datepicker @error('opening_date') is-invalid @enderror"
                                        id="opening_date" name="opening_date"
                                        value="{{ old('opening_date', date('d/m/Y')) }}" required placeholder="dd/mm/yyyy"
                                        readonly>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="monthly_amount" name="monthly_amount" value="{{ old('monthly_amount') }}"
                                        required placeholder="Enter amount in multiples of 100" pattern="[0-9]+"
                                        inputmode="numeric">
                                    <div class="input-group-append">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('total_deposited') is-invalid @enderror"
                                    id="total_deposited" name="total_deposited" value="{{ old('total_deposited', 0) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number"
                                    class="form-control @error('installments_paid') is-invalid @enderror"
                                    id="installments_paid" name="installments_paid"
                                    value="{{ old('installments_paid', 0) }}" min="0" step="1">
                                <small class="text-muted">
                                    <i class="fas fa-info-circle text-info"></i>
        ...
        $(document).ready(function() {
            ...
            function formatCustomerOption(customer) {
                ...
                var $result = $(
                    ...
                    '<div class="customer-name"><i class="fas fa-user text-primary"></i> <strong>' + name +
                    '</strong></div>' +
                    '<div class="customer-details">' +
                    '<span class="customer-phone"><i class="fas fa-phone text-success"></i> ' + phone +
                    '</span>' +
                    (email ? '<span class="customer-email"><i class="fas fa-envelope text-info"></i> ' + email +
                        '</span>' : '') +
                    '</div>' +
                    '</div>'
                );
