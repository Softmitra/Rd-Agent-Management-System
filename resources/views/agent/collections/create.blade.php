...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="GET" action="{{ route('collections.create') }}" class="row g-3 align-items-center">
                <div class="col-auto">
                    <input type="text" name="search" class="form-control" placeholder="Name, Mobile, or CIF ID" value="{{ request('search') }}">
                </div>
                <div class="col-auto">
                    ...
                    <tbody>
                        @foreach($rdAccounts as $account)
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('collections.show', $account->id) }}" class="btn btn-info btn-sm">
    ...
    <div class="card mb-4">
        <div class="card-body text-center">
            ...
            <p class="text-muted">No active RD accounts found for "{{ request('search') }}". Please try a different search term.</p>
        </div>
    </div>
    @else
    <!-- Default Message -->
    <div class="card mb-4">
        <div class="card-body text-center">
            ...
            <p class="text-muted">Enter customer name, mobile number, or CIF ID to view their active RD accounts and enter collections.</p>
        </div>
    </div>
    @endif
</div>
            ...
            <form action="{{ route('collections.store') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="amount" name="amount" step="0.01" required readonly>
                    </div>
