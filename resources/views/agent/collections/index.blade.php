        ...
        <div class="card-body">
            <form method="GET" action="{{ route('collections.index') }}" class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="text" name="account_number" class="form-control" placeholder="Search account..." value="{{ request('account_number') }}">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-2">
                    ...
                    <select name="status" class="form-control">
                        ...
                        <option value="Not in Lot" {{ request('status') == 'Not in Lot' ? 'selected' : '' }}>Not in Lot</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('payments.show', $collection->id) }}" class="btn btn-outline-primary btn-sm">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    @if($collection->status == 'Not in Lot')
                                    <button class="btn btn-outline-success btn-sm" onclick="markInLot({{ $collection->id }})">
